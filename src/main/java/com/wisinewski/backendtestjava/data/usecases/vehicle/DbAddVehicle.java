...
public class DbAddVehicle implements AddVehicle {
	...
	@Autowired
	public DbAddVehicle(LoadVehicleTypeByIdRepository loadVehicleTypeByIdRepository, AddVehicleRepository addVehicleRepository) {
	...
	public void addVehicle(VehicleParams vehicleParams) {
		...
		Vehicle vehicle = new Vehicle(vehicleParams.getBrand(), vehicleParams.getModel(), vehicleParams.getColor(), vehicleParams.getLicensePlate(), optionalVehicleType.get());
